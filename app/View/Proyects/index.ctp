  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td class="actions">
	    ...
	    <a>
			<?php echo $this->Form->postLink(__(''), array('action' => 'delete', $proyect['Proyect']['id']), array('class'=>'btn btn-danger fas fa-trash' ,'confirm' => __('Estas seguro de eliminar el proyecto %s?', $proyect['Proyect']['title']))); ?>
		</a>	
	  </td>
    </tr>
	<?php endforeach; ?>
