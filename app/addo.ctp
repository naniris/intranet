...
<?php echo $this->Form->create('Order'); ?>
	...
	<div class="container mt-3">
		...
		<div class="row shadow p-2">
			...
			<?php
			echo $this->Form->input('description',array('label'=>'','rows'=>'32','style'=>'width:100%'));
...
<!--**********************************-->
				...
				<div class="col-11">
				<button type="submit" class="btn btn-dark my-3 my-sm-0 mx-3 btn-block" name="button">Generar Orden</button>
